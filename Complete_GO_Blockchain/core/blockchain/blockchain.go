...
import (
	...
	transactions "github.com/girish/proper_blockchain/core/transactions"
)
...
func (bc *Blockchain) FindUTXO() map[string]transactions.TXOutputs {
...
func (bc *Blockchain) MineBlock(transactions []*transactions.Transaction) *Block {
	var lastHash []byte
	var lastHeight int
